...
plot_data$meas = factor(plot_data$meas, levels=c(1,3,4,2,5))
...
for (m in fc){
  ...
  groups = c(rep(1,each=7),rep(2,each=2),rep(3,each=3),rep(4,each=1),5,rep(6,each=9),rep(7,each=2),8,rep(9,each=2),rep(10,each=8),rep(11,each=2), 12)
  if (pred == 'num'){
