...
for (m in fc){
  ...
  if (pred == 'num'){
    fit = aovp(data=curr, str_beta_num ~ contacts + race + gender + hand + age + Institution)
  } else if (pred == 'bin') {
    fit = aovp(data=curr, str_beta_bin ~ contacts + race + gender + hand + age + Institution)
  } else {
    fit = aovp(data=curr, str_beta_spr ~ contacts + race + gender + hand + age + Institution)
  }
