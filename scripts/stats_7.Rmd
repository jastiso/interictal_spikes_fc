...
for (m in fc){
  ...
  groups = c(rep(1,each=7),rep(2,each=2),rep(3,each=3),rep(4,each=1),5,rep(6,each=9),rep(7,each=2),8,rep(9,each=3),rep(10,each=7),rep(11,each=4), 12)
  if (pred == 'num'){
  ...
  fit_cv = cv.gglasso(x=x,y=y,group=groups,nfolds = 3)
