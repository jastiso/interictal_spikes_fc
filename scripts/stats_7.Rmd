...
stats_pred_avg = group_by(stats_pred, meas, mean_r = mean(r), std_r = stdin(r))
stats_pred_avg
```
...
I think ridge regression is better suited for this analysis.
Placeholder until I figure out grouped ridge regression (using GRridge)
```{r}
pred = 'bin'
supp_flag = FALSE # are you using main measures, or supplemental measures
k=10
