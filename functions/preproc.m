        ...
        for e = 1:numel(experiments)
            ...
            for n = 1:numel(sessions)
                ...
                for j = 1:nTrial
                    ...
                    %                                 ft_databrowser(ft_data.trial{j}(:, cnt:end), 'srate', header.sample_rate,  "winlength", 100);
                    ...
                    saveas(gcf, [img_dir, 'preCAR_LFP_', num2str(j), '.png'], 'png')
                    close all
                end
                ...
                for j = 1:nTrial
                    ...
                    cfg = [];
                    ft_databrowser(cfg,ft_data);
                    saveas(gcf, [img_dir, 'postCAR_LFP_', num2str(j), '.png'], 'png')
                    close all
